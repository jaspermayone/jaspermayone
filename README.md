...
- [slack-bot](https://github.com/phish-directory/slack-bot) - **VERY WORK IN PROGRES** (today)
...
- [project-idea-ai-fine-tuning](https://github.com/jaspermayone/project-idea-ai-fine-tuning) - failed attempt at training an ai to recognize project ideas in slack (today)
- [.github](https://github.com/phish-directory/.github) -  (today)
